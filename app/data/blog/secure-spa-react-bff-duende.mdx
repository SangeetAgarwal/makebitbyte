...
draft: false
summary: Rather than having access tokens in the browser, we'll use the BFF architecture to store only HttpOnly cookies in the browser and use a server based backend to manage our access tokens.
layout: PostSimpleLayout
images: ["/static/images/bff/securingspabffduende.jpg"]
---
